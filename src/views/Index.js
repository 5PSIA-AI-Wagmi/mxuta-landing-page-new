...
export default function Index() {
  return (
    <>
      ...
      <div
        data-aos="fade-right"
        className="right-arrow bottom-0 b-auto left-0"
      ...
      >
        <div
          className="container mx-auto items-center flex flex-wrap text-white"
          style={{ zIndex: 999 }}
        >
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-56 mt-12 sm:pt-0">
              <h2 className="font-semibold text-4xl">
                Mxuta Store - Top Up Games - Murah, aman, terpercaya.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-secondary">
                Proses Top Up Otomatis/Instant (1 Menit) Open 24 Jam. Saat ini,
                Mxuta Store menyediakan layanan Top Up Games seperti Mobile
                Legends & Free Fire. Disini terdapat beberapa pembayaran seperti
                E-Waller, QRIS, Virtual Account, Saldo Mxuta, Alfamart &
                Indomaret. Jika mengalami kendala, dapat menghubungi CS.
              </p>
              <div className="mt-12">
                <a
        ...
        <img
          data-aos="fade-down"
          className="absolute top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-56 sm:mt-0 max-h-860px"
          src={require("assets/img/image-1.png").default}
          alt="..."
        />
      </section>
