...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav
        className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-gray text-white shadow"
        style={{ zIndex: 9999 }}
      >
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link
              to="/"
              className="text-lg font-bolder leading-relaxed inline-block mr-4 py-2 whitespace-nowrap"
            >
              <div
                style={{
                  display: "flex",
